/**
 * wordGeneratorBMED2.js
 * Generates the 2nd Year (4th Semester) Biomedical Engineering RBU Detention List .docx.
 *
 * Table I:    SN | Exam Seat No | Name | Aggregate Attendance %
 * Table II:   SN | Exam Seat No | Name | Aggregate Attendance %
...
// ── Main generator ────────────────────────────────────────────────────────────
async function generateWordBMED2(meta, { tableI, tableII, tableIIIA, tableIIIB }, outputPath) {
    ...
    sections: [{
      ...
      children: [
        ...
        new Paragraph({
          spacing: { after: 60 },
          children: [
            normal('Table I is the list of students of programme Biomedical Engineering semester IV having aggregate attendance less than 75%.', 19),
          ],
        }),
        new Paragraph({
          spacing: { after: 100 },
        ...
        new Paragraph({
          spacing: { after: 60 },
          children: [
            normal('However Table II, is the list of students of programme Biomedical Engineering semester IV having aggregate attendance between 60% and 75% and has applied for condonation of attendance. The application forms and medical certificates / other relevant documents have been attached herewith. After due consideration and as per the regulation R 17, it is recommended that these students may be permitted to appear in all courses in the ', 19),
            bold(examName, 19),
...
module.exports = { generateWordBMED2 };
